...
Our Research Question is:
  ...
  The data is an excel type of structure called a data frame. There are 30 observations on three seperate variables, namely weight, pushups and position. Weight and pushups are numerical variables, while position is a categorical variable with values. SKILL or LINE.
...
We will get a numerical summary of our data with summary command to see on average how many pushups were done in the various player groups. 
